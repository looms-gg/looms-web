...
import { multiplyM44, scaleM44, translateM44, type M44, type V3 } from "./maths";
...
export class MinecraftSkin extends MeshGroup {
  ...
  static async create(
    ...
    // Resolution multiplier: the editor only handles the standard 64x64 atlas.
    const m = 1;
    const ps = 1.0;
  ...
  public onVisibilityChangeFromStore(
    ...
    const isPocket = storeState.skinIsSlim;
