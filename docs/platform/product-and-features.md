...
- **Seeded catalogue**: 22 named launch pieces (Ash Crop hair, Winter Coat, Baggy Skull Pants, Knee-High Converse, Football Helmet, Anonymous Mask, Skull Mask, Christmas Sweater, camo & moon pants, sneakers…) with personality-rich blurbs. This is the "floor" content every visitor sees. Note: blurbs are maker-voice UGC, quirk and humor belong to creators; official platform copy stays warm and wholesome (see the brand guide).
