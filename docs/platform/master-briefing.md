...
- **Personality:** playful, collectible, "plaza-bright" — social energy borrowed from ShareMii.net (rounded tiles, pill buttons, bright accent) retargeted at outfits. Voice is short, inviting, and concrete: piece names, layer slots, wear and export — not marketplace hype.
...
- **Copy tone examples:** "Be cool in the closet", "The closet is yours", blurb style like "Huge charcoal baggies. Your shoes are in there somewhere. Probably."
- **Accessibility:** WCAG 2.2 AA target, ≥44px hit targets, reduced-motion support, never color-alone for state.
